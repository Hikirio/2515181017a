...
<head>
    ...
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false&key=AIzaSyBdT50UIw-fjvUKqZmlC-NuzZuN1tstrN4" ></script>
                            ...
                            <div class="r_col">
                                ...
                                <div class="uo_adr_list">
                                    ...
                                    <tr>
                                        ...
                                        <!--                                        <div class="item">-->
                                        <!--                                            <h3>Work Address</h3>-->
                                        <!--                                            <p>Dubai, Business Bay Area, Sheikh Zayed Road, Single<br/>Business Tower,-->
                                        <!--                                                Suite 2204</p>-->
                                        <!--                                            <div class="actbox" >-->
                                        <!--                                                <a href="index.php?del_id=-->
                                        <? //= $id = $value->id ?><!--" name="del" id="del" class="bcross"></a>-->
                                        <!--                                            </div>-->
                                        <!--                                        </div>-->
                                        <? endforeach ?>
                                </div>
